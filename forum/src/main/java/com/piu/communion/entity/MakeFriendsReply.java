...
public class MakeFriendsReply extends DataEntity<MakeFriendsReply> {
	...
	public MakeFriends getMakeFriends() {
		return makeFriends;
	}

	public void setMakeFriends(MakeFriends makeFriends) {
